...
if (!class_exists('skeleton_wp_Redux_Framework_config')) {
    ...
    class skeleton_wp_Redux_Framework_config {
...
//                        'desc'      => __('', 'redux-framework-demo'),
                    ...
                    array(
                        'id'        => 'skeleton_wp_copyright',
                        'type'      => 'editor',
                        'title'     => __('Footer Copyright Text', 'redux-framework-demo'),
                        'subtitle'  => __('You can use the following shortcodes in your footer text:<br><code>[wp-url]
                        [site-url] [theme-url] [login-url] [logout-url] [site-title] [site-tagline]
                        [current-year]</code><br><br><strong>Note:</strong> Shortcodes will be rendered on the front-end', 'redux-framework-demo'),
                        'default'   => '&copy; [site-title] [current-year]',
                    )
                )
            );
